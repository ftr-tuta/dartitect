...
/// Fully managed contract harness selected from the ReplicaApplication1 feature profile.
final class ReplicaApplication1FeatureHarness<
  T extends OnlineFeatureContractDriver
> {
  const ReplicaApplication1FeatureHarness({required this.fixtures});
