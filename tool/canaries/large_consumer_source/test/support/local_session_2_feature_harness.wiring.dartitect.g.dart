...
/// Fully managed contract harness selected from the LocalSession2 feature profile.
final class LocalSession2FeatureHarness<T extends OnlineFeatureContractDriver> {
  const LocalSession2FeatureHarness({required this.fixtures});
  ...
  FeatureContractMatrix<T> get matrix =>
      FeatureContractMatrix<T>.local(fixtures: fixtures);
