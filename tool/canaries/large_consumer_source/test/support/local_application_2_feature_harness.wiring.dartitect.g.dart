...
/// Fully managed contract harness selected from the LocalApplication2 feature profile.
final class LocalApplication2FeatureHarness<
  T extends OnlineFeatureContractDriver
> {
  const LocalApplication2FeatureHarness({required this.fixtures});
