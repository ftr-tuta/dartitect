...
/// Fully managed contract harness selected from the OfflineFullSession1 feature profile.
final class OfflineFullSession1FeatureHarness<
  T extends OnlineFeatureContractDriver
> {
  const OfflineFullSession1FeatureHarness({required this.fixtures});
