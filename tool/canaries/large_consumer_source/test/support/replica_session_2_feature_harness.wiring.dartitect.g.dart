...
/// Fully managed contract harness selected from the ReplicaSession2 feature profile.
final class ReplicaSession2FeatureHarness<
  T extends OnlineFeatureContractDriver
> {
  const ReplicaSession2FeatureHarness({required this.fixtures});
