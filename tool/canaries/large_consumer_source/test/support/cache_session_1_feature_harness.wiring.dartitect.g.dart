...
/// Fully managed contract harness selected from the CacheSession1 feature profile.
final class CacheSession1FeatureHarness<T extends OnlineFeatureContractDriver> {
  const CacheSession1FeatureHarness({required this.fixtures});
