...
/// Fully managed contract harness selected from the OfflineFullSession2 feature profile.
final class OfflineFullSession2FeatureHarness<
  T extends OnlineFeatureContractDriver
> {
  const OfflineFullSession2FeatureHarness({required this.fixtures});
