...
/// Fully managed contract harness selected from the ReplicaApplication3 feature profile.
final class ReplicaApplication3FeatureHarness<
  T extends OnlineFeatureContractDriver
> {
  const ReplicaApplication3FeatureHarness({required this.fixtures});
