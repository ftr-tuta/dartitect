...
/// Fully managed contract harness selected from the CacheApplication1 feature profile.
final class CacheApplication1FeatureHarness<
  T extends OnlineFeatureContractDriver
> {
  const CacheApplication1FeatureHarness({required this.fixtures});
