...
/// Fully managed contract harness selected from the CacheSession3 feature profile.
final class CacheSession3FeatureHarness<T extends OnlineFeatureContractDriver> {
  const CacheSession3FeatureHarness({required this.fixtures});
