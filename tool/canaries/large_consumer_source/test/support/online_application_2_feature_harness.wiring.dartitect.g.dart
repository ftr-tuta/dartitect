...
/// Fully managed contract harness selected from the OnlineApplication2 feature profile.
final class OnlineApplication2FeatureHarness<
  T extends OnlineFeatureContractDriver
> {
  const OnlineApplication2FeatureHarness({required this.fixtures});
