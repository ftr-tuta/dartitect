...
/// Fully managed contract harness selected from the OnlineSession3 feature profile.
final class OnlineSession3FeatureHarness<
  T extends OnlineFeatureContractDriver
> {
  const OnlineSession3FeatureHarness({required this.fixtures});
