...
/// Fully managed contract harness selected from the LocalApplication3 feature profile.
final class LocalApplication3FeatureHarness<
  T extends OnlineFeatureContractDriver
> {
  const LocalApplication3FeatureHarness({required this.fixtures});
