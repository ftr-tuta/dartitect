...
/// Fully managed contract harness selected from the OfflineFullSession3 feature profile.
final class OfflineFullSession3FeatureHarness<
  T extends OnlineFeatureContractDriver
> {
  const OfflineFullSession3FeatureHarness({required this.fixtures});
