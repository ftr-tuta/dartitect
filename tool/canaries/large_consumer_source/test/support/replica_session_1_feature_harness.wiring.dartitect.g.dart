...
/// Fully managed contract harness selected from the ReplicaSession1 feature profile.
final class ReplicaSession1FeatureHarness<
  T extends OnlineFeatureContractDriver
> {
  const ReplicaSession1FeatureHarness({required this.fixtures});
