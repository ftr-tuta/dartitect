...
/// Fully managed contract harness selected from the LocalSession3 feature profile.
final class LocalSession3FeatureHarness<T extends OnlineFeatureContractDriver> {
  const LocalSession3FeatureHarness({required this.fixtures});
