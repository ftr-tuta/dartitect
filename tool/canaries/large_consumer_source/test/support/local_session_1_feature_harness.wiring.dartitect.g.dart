...
/// Fully managed contract harness selected from the LocalSession1 feature profile.
final class LocalSession1FeatureHarness<T extends OnlineFeatureContractDriver> {
  const LocalSession1FeatureHarness({required this.fixtures});
