...
/// Fully managed contract harness selected from the OnlineSession2 feature profile.
final class OnlineSession2FeatureHarness<
  T extends OnlineFeatureContractDriver
> {
  const OnlineSession2FeatureHarness({required this.fixtures});
