...
/// Fully managed contract harness selected from the OfflineFullApplication2 feature profile.
final class OfflineFullApplication2FeatureHarness<
  T extends OnlineFeatureContractDriver
> {
  const OfflineFullApplication2FeatureHarness({required this.fixtures});
