...
/// Fully managed contract harness selected from the ReplicaSession3 feature profile.
final class ReplicaSession3FeatureHarness<
  T extends OnlineFeatureContractDriver
> {
  const ReplicaSession3FeatureHarness({required this.fixtures});
