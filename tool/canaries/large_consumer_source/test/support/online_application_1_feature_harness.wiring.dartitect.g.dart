...
/// Fully managed contract harness selected from the OnlineApplication1 feature profile.
final class OnlineApplication1FeatureHarness<
  T extends OnlineFeatureContractDriver
> {
  const OnlineApplication1FeatureHarness({required this.fixtures});
