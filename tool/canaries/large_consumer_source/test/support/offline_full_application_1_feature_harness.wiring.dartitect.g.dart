...
/// Fully managed contract harness selected from the OfflineFullApplication1 feature profile.
final class OfflineFullApplication1FeatureHarness<
  T extends OnlineFeatureContractDriver
> {
  const OfflineFullApplication1FeatureHarness({required this.fixtures});
