...
/// Fully managed contract harness selected from the CacheApplication3 feature profile.
final class CacheApplication3FeatureHarness<
  T extends OnlineFeatureContractDriver
> {
  const CacheApplication3FeatureHarness({required this.fixtures});
