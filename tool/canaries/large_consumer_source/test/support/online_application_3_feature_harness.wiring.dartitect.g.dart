...
/// Fully managed contract harness selected from the OnlineApplication3 feature profile.
final class OnlineApplication3FeatureHarness<
  T extends OnlineFeatureContractDriver
> {
  const OnlineApplication3FeatureHarness({required this.fixtures});
