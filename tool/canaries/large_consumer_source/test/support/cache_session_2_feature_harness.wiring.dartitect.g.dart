...
/// Fully managed contract harness selected from the CacheSession2 feature profile.
final class CacheSession2FeatureHarness<T extends OnlineFeatureContractDriver> {
  const CacheSession2FeatureHarness({required this.fixtures});
  ...
  FeatureContractMatrix<T> get matrix =>
      FeatureContractMatrix<T>.cache(fixtures: fixtures);
