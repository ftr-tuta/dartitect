...
/// Fully managed contract harness selected from the LocalApplication1 feature profile.
final class LocalApplication1FeatureHarness<
  T extends OnlineFeatureContractDriver
> {
  const LocalApplication1FeatureHarness({required this.fixtures});
