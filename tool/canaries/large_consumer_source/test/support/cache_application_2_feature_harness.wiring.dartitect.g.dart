...
/// Fully managed contract harness selected from the CacheApplication2 feature profile.
final class CacheApplication2FeatureHarness<
  T extends OnlineFeatureContractDriver
> {
  const CacheApplication2FeatureHarness({required this.fixtures});
