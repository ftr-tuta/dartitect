...
final class OnlineApplication3DioModule implements Disposable {
  OnlineApplication3DioModule._(this.owner, this.client);

  factory OnlineApplication3DioModule.create({
    ...
    return OnlineApplication3DioModule._(
      owner,
