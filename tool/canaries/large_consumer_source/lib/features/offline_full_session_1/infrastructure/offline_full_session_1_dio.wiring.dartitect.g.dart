...
final class OfflineFullSession1DioModule implements Disposable {
  OfflineFullSession1DioModule._(this.owner, this.client);

  factory OfflineFullSession1DioModule.create({
    ...
    return OfflineFullSession1DioModule._(
      owner,
