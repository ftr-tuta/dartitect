...
final class OnlineSession2DioModule implements Disposable {
  OnlineSession2DioModule._(this.owner, this.client);

  factory OnlineSession2DioModule.create({
    ...
    return OnlineSession2DioModule._(owner, DefaultDioJsonClient(owner.dio));
  }
