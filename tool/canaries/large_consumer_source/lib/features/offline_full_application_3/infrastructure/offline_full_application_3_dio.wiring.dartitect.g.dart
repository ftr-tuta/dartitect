...
final class OfflineFullApplication3DioModule implements Disposable {
  OfflineFullApplication3DioModule._(this.owner, this.client);

  factory OfflineFullApplication3DioModule.create({
    ...
    return OfflineFullApplication3DioModule._(
      owner,
      DefaultDioJsonClient(owner.dio),
    );
  }
