...
final class CacheApplication1DioModule implements Disposable {
  CacheApplication1DioModule._(this.owner, this.client);

  factory CacheApplication1DioModule.create({
    ...
    return CacheApplication1DioModule._(owner, DefaultDioJsonClient(owner.dio));
  }
