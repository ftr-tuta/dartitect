...
final class OfflineFullApplication1DioModule implements Disposable {
  OfflineFullApplication1DioModule._(this.owner, this.client);

  factory OfflineFullApplication1DioModule.create({
    ...
    return OfflineFullApplication1DioModule._(
      owner,
