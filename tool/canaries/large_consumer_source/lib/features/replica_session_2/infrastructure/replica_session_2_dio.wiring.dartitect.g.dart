...
final class ReplicaSession2DioModule implements Disposable {
  ReplicaSession2DioModule._(this.owner, this.client);

  factory ReplicaSession2DioModule.create({
    ...
    return ReplicaSession2DioModule._(owner, DefaultDioJsonClient(owner.dio));
  }
