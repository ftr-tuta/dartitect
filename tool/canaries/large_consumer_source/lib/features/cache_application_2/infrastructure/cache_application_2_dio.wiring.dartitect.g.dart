...
final class CacheApplication2DioModule implements Disposable {
  CacheApplication2DioModule._(this.owner, this.client);

  factory CacheApplication2DioModule.create({
    ...
    return CacheApplication2DioModule._(owner, DefaultDioJsonClient(owner.dio));
  }
