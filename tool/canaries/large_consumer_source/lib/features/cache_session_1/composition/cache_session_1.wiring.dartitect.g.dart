...
/// Exact contexts selected by the CacheSession1 feature profile.
final class CacheSession1Infrastructure {
  const CacheSession1Infrastructure({
...
final class CacheSession1Runtime {
  const CacheSession1Runtime({
  ...
  final CacheSession1Factory factory;
  final CacheSession1Infrastructure infrastructure;
  ...
  static Future<CacheSession1Runtime> create(
    SessionGraph graph,
    CacheSession1Factory factory,
    ResourceTransaction transaction,
  ) async {
    final infrastructure = CacheSession1Infrastructure(
    ...
    final repository = transaction.own<LargeRepository>(
      ...
      label: 'feature.cache_session_1.repository',
    );
    return CacheSession1Runtime(
      factory: factory,
...
/// Material-neutral generated owner for the CacheSession1 feature.
final class CacheSession1FeatureHost extends StatelessWidget {
  const CacheSession1FeatureHost({
    required this.graph,
    required this.factory,
  ...
  final FeatureReadyBuilder<CacheSession1Runtime, LargeViewModel> ready;
  final FeatureViewModelStarter<LargeViewModel>? start;
  final FutureOr<void> Function()? onDisposed;

  @override
  Widget build(BuildContext context) =>
      FeatureHost<SessionGraph, CacheSession1Runtime, LargeViewModel>(
        parent: graph,
        generationKey: factory,
        createGraph: (parent, transaction) =>
            CacheSession1Runtime.create(parent, factory, transaction),
...
abstract final class CacheSession1FeatureWiring {
