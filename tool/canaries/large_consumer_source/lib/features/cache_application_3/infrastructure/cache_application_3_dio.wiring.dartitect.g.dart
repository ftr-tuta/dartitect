...
final class CacheApplication3DioModule implements Disposable {
  CacheApplication3DioModule._(this.owner, this.client);

  factory CacheApplication3DioModule.create({
    ...
    return CacheApplication3DioModule._(owner, DefaultDioJsonClient(owner.dio));
  }
