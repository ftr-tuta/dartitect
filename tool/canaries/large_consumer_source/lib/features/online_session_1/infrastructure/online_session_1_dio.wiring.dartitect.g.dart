...
final class OnlineSession1DioModule implements Disposable {
  OnlineSession1DioModule._(this.owner, this.client);

  factory OnlineSession1DioModule.create({
    ...
    return OnlineSession1DioModule._(owner, DefaultDioJsonClient(owner.dio));
  }
