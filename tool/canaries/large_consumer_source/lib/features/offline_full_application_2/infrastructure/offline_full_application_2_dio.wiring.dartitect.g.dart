...
final class OfflineFullApplication2DioModule implements Disposable {
  OfflineFullApplication2DioModule._(this.owner, this.client);

  factory OfflineFullApplication2DioModule.create({
    ...
    return OfflineFullApplication2DioModule._(
      owner,
