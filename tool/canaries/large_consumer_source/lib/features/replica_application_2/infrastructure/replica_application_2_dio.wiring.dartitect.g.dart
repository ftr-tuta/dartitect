...
final class ReplicaApplication2DioModule implements Disposable {
  ReplicaApplication2DioModule._(this.owner, this.client);

  factory ReplicaApplication2DioModule.create({
    ...
    return ReplicaApplication2DioModule._(
      owner,
