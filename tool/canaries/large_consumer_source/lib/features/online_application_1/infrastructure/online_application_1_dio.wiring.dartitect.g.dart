...
final class OnlineApplication1DioModule implements Disposable {
  OnlineApplication1DioModule._(this.owner, this.client);

  factory OnlineApplication1DioModule.create({
    ...
    return OnlineApplication1DioModule._(
      owner,
