...
final class OfflineFullSession3DioModule implements Disposable {
  OfflineFullSession3DioModule._(this.owner, this.client);

  factory OfflineFullSession3DioModule.create({
    ...
    return OfflineFullSession3DioModule._(
      owner,
