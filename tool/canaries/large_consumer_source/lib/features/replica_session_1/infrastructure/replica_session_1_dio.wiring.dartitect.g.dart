...
final class ReplicaSession1DioModule implements Disposable {
  ReplicaSession1DioModule._(this.owner, this.client);

  factory ReplicaSession1DioModule.create({
    ...
    return ReplicaSession1DioModule._(owner, DefaultDioJsonClient(owner.dio));
  }
