...
final class ReplicaApplication1DioModule implements Disposable {
  ReplicaApplication1DioModule._(this.owner, this.client);

  factory ReplicaApplication1DioModule.create({
    ...
    return ReplicaApplication1DioModule._(
      owner,
