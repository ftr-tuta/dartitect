...
final class OfflineFullSession2DioModule implements Disposable {
  OfflineFullSession2DioModule._(this.owner, this.client);

  factory OfflineFullSession2DioModule.create({
    ...
    return OfflineFullSession2DioModule._(
      owner,
