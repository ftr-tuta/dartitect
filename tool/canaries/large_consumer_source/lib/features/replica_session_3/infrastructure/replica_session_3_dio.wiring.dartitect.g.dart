...
final class ReplicaSession3DioModule implements Disposable {
  ReplicaSession3DioModule._(this.owner, this.client);

  factory ReplicaSession3DioModule.create({
    ...
    return ReplicaSession3DioModule._(owner, DefaultDioJsonClient(owner.dio));
  }
