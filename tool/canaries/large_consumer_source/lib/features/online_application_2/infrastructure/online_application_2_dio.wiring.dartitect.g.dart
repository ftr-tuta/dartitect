...
final class OnlineApplication2DioModule implements Disposable {
  OnlineApplication2DioModule._(this.owner, this.client);

  factory OnlineApplication2DioModule.create({
    ...
    return OnlineApplication2DioModule._(
      owner,
