...
final class ReplicaApplication3DioModule implements Disposable {
  ReplicaApplication3DioModule._(this.owner, this.client);

  factory ReplicaApplication3DioModule.create({
    ...
    return ReplicaApplication3DioModule._(
      owner,
