...
/// Exact contexts selected by the ReplicaApplication3 feature profile.
final class ReplicaApplication3Infrastructure {
  const ReplicaApplication3Infrastructure({
...
final class ReplicaApplication3Runtime {
  const ReplicaApplication3Runtime({
  ...
  final ReplicaApplication3Factory factory;
  final ReplicaApplication3Infrastructure infrastructure;
  ...
  static Future<ReplicaApplication3Runtime> create(
    ApplicationGraph graph,
    ReplicaApplication3Factory factory,
    ResourceTransaction transaction,
  ) async {
    final infrastructure = ReplicaApplication3Infrastructure(
    ...
    final syncEngine = transaction.own<SyncEngine<String, int, LargeFailure>>(
      ...
      label: 'feature.replica_application_3.sync',
    );
    final repository = transaction.own<LargeRepository>(
      ...
      (value) => value.disposeAsync(),
      label: 'feature.replica_application_3.repository',
    );
    return ReplicaApplication3Runtime(
      factory: factory,
...
/// Material-neutral generated owner for the ReplicaApplication3 feature.
final class ReplicaApplication3FeatureHost extends StatelessWidget {
  const ReplicaApplication3FeatureHost({
    required this.graph,
    required this.factory,
  ...
  final FeatureReadyBuilder<ReplicaApplication3Runtime, LargeViewModel> ready;
  final FeatureViewModelStarter<LargeViewModel>? start;
  final FutureOr<void> Function()? onDisposed;

  @override
  Widget build(BuildContext context) =>
      FeatureHost<ApplicationGraph, ReplicaApplication3Runtime, LargeViewModel>(
        parent: graph,
        generationKey: factory,
        createGraph: (parent, transaction) =>
            ReplicaApplication3Runtime.create(parent, factory, transaction),
...
abstract final class ReplicaApplication3FeatureWiring {
