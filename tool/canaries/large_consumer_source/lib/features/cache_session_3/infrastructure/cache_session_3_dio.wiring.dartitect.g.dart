...
final class CacheSession3DioModule implements Disposable {
  CacheSession3DioModule._(this.owner, this.client);

  factory CacheSession3DioModule.create({
    ...
    return CacheSession3DioModule._(owner, DefaultDioJsonClient(owner.dio));
  }
