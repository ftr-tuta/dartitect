...
/// Checks the same-host RC3/RC4 modeling comparison and hard resource budgets.
void main() {
  ...
  if (artifact['schemaVersion'] != 2 ||
      artifact['targetVersion'] != '1.0.0-rc.4' ||
      policy['coldRuns'] != 5 ||
      policy['warmRuns'] != 20 ||
      policy['maxRegressionPercent'] != 10.0 ||
      policy['cacheAuthority'] != false ||
      policy['sameHostRequired'] != true) {
    errors.add('Model benchmark policy is not the frozen RC4 contract.');
  }
  ...
  stdout.writeln(
    'Model benchmark passes: same-host RC3/RC4, five cold medians/RSS, '
