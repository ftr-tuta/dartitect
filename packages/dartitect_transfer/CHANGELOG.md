...
- Version-only stable release; transfer diagnostics remain payload-free.
...
- Add resumable source, sink, transport, checkpoint, chunk, checksum,
  pause/resume/cancel, deadline, and typed progress contracts.
