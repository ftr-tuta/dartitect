...
generated-once. O scanner da CLI e o plugin do analyzer compartilham as regras
`DT1001` a `DT1015`.
...
são relativos ao repositório; código gerado só é excluído por patterns explícitos.
