...
/// Fully managed contract harness selected from the PavedRoad feature profile.
final class PavedRoadFeatureHarness<T extends OnlineFeatureContractDriver> {
  const PavedRoadFeatureHarness({required this.fixtures});
