...
/// Fully managed contract harness selected from the Tasks feature profile.
final class TasksFeatureHarness<T extends OnlineFeatureContractDriver> {
  const TasksFeatureHarness({required this.fixtures});
